    ...
    <footer className="bg-slate-900 text-white pt-12 pb-6" data-reveal="fade">
      <div className="container">
        <div className="grid gap-8 mb-8 md:grid-cols-[2fr_1fr_1fr]">
          ...
          <div>
            <Link href={getMainSiteHref('/')} className="inline-flex flex-row items-end gap-1.5 md:gap-2 group mb-6 no-underline text-inherit">
...
{t('footer.buka_di_google_maps')}
          ...
          <div>
            ...
            <ul className="list-none p-0 m-0">
              <li className="mb-2"><Link href={getMainSiteHref('/produk')} className="text-slate-400 no-underline transition-colors duration-200 hover:text-white">{t('footer.katalog_produk')}</Link></li>
              <li className="mb-2"><Link href={getMainSiteHref('/harga-sewa-kasur')} className="text-slate-400 no-underline transition-colors duration-200 hover:text-white">{t('footer.harga_sewa_busa')}</Link></li>
        ...
        <div className="border-t border-slate-800 pt-6 text-center text-slate-500 text-sm">
          <p className="mb-1">&copy; {currentYear} {config.businessName}. {t('footer.copyright')}</p>
