 ...
 *
 * Copied from @sync-erp/shared to remove cross-repo dependency for Railway deployment.
 */
...
>;
export type PublicRentalConfirmPaymentByOrderNumberInputType = z.infer<
  typeof PublicRentalConfirmPaymentByOrderNumberInput
>;
